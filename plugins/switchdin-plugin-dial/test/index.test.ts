 ...
 * under the License.
 */
import { SwitchdinPluginDialChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-switchdin-plugin-dial', () => {
  it('exists', () => {
    expect(SwitchdinPluginDialChartPlugin).toBeDefined();
  });
});
